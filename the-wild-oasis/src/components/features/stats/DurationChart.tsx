...
import { RecentStays } from "@/types/stats.types";
...
const startData: DurationData[] = [
  ...
  //   { duration: "6-7 nights", value: 4, fill: "var(--chart-5)" },
  //   { duration: "8-14 nights", value: 10, fill: "var(--chart-1)" },
  //   { duration: "15-21 nights", value: 0, fill: "var(--chart-2)" },
  //   { duration: "21+ nights", value: 0, fill: "var(--chart-3)" },
];
  ...
  return (
    <Card className="flex flex-col">
      ...
      <CardContent className="flex-1 pb-0">
        ...
        >
          <PieChart>
            <Pie data={durationData} dataKey="value" nameKey="duration" />
